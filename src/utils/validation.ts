...
const INVALID_TEXT_MESSAGE = 'El texto solo debe contener letras y espacios';
...
const INVALID_PHONE_MESSAGE = 'El telefono debe ser un numero movil valido de 10 digitos (ej. 0984653471)';
const INVALID_IDENTIFICATION_MESSAGE = 'La identificacion debe ser numerica y valida para el tipo seleccionado';
